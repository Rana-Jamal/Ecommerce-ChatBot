...
**1. Application Interface (`E_commerce_chat_bot_ss1`)**
...
**2. FAQ Retrieval (RAG Pipeline) (`E_commerce_chat_bot_ss2`)**
...
**3. Product Search (Text-to-SQL Pipeline) (`E_commerce_chat_bot_ss3`)**
